                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        children: [
                          ...
                          TextSpan(
                            text: "This venue supports booking cancellation. To know more ",
                          ),
                          TextSpan(
                            text: "view cancellation policy",
                            style: TextStyle(color: Colors.blue),
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text("Ticket(s) price", style: TextStyle(color: Colors.black, fontSize: 12)),
                      ),
                      Text("₹${ticketPrice.toStringAsFixed(2)}", style: TextStyle(color: Colors.black, fontSize: 12)),
                    ],
                  ),
                  const SizedBox(height: 10),
                  Row(
                    children: [
                      Expanded(
                        child: Text("Convenience fees", style: TextStyle(color: Colors.black, fontSize: 12)),
                      ),
                      Text("₹${convenienceFee.toStringAsFixed(2)}", style: TextStyle(color: Colors.black, fontSize: 12)),
                    ],
                  ),
                  SizedBox(height: 10),
                  Row(
                  ...
                  Row(
                    children: [
                      Expanded(
                        child: Text("Order total", style: TextStyle(color: Colors.black, fontSize: 12)),
                      ),
                      Text("₹${totalAmount.toStringAsFixed(2)}", style: TextStyle(color: Colors.black, fontSize: 12)),
                    ],
                  ),
                ],
              ),
                ...
                children: [
                  Row(
                    children: const [
                      ...
                      Text("Edit", style: TextStyle(color: Colors.red, fontSize: 12)),
                    ],
                  ),
                  const SizedBox(height: 8),
                  const Text(
            ...
            Container(
              ...
              child: Row(
                children: const [
                  ...
                  SizedBox(width: 10),
                  Expanded(
                    child: Text("Apply Offers", style: TextStyle(fontWeight: FontWeight.bold)),
                  ),
                  Icon(Icons.chevron_right),
                ],
              ),
